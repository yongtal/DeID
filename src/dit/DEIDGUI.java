...
import dit.panels.WelcomePanel;
...
public class DEIDGUI extends javax.swing.JFrame {
    ...
    public DEIDGUI() {
            ...
            public void windowClosing(WindowEvent e) {
              ...
              //  
                ...
                try {
                    ...
                    System.out.println("Recursive Delete " + DeidData.outputPath);
        ...
        pagePanel.add(new WelcomePanel());
	...
	//Date date = new Date();
        ...
        LoggerWrapper.myLogger.fine("##############Starting a new program #################");
        //loggerWrapper.myLogger.fine(dateFormat.format(date));
    ...
    private void unpackTools() {
        ...
        if(FileUtils.OS.isMac()){
            ...
            outputPath = "C:"+File.separator + File.separator + "Temp" + fileSeparator;
            osPrefix = "win";
            toolNames = new String[]{
                "bet.exe",
               //"ROBEX.exe",
        ...
        String gzfiles[] = new String[]{
            File.separator + "tmp" + File.separator + "dit_tools" + File.separator + "libnewmat.so.10", 
            File.separator + "tmp" + File.separator + "dit_tools" + File.separator + "libniftiio.so.2",
            File.separator + "tmp" + File.separator + "dit_tools" + File.separator + "libstdc++.so.6", 
            File.separator + "tmp" + File.separator + "dit_tools" + File.separator + "libz.so.1", 
            File.separator + "tmp" + File.separator + "dit_tools" + File.separator + "libznz.so.2"
        };
        String zipfiles[]= new String[]{};
        if(FileUtils.OS.isWindows())
        {  
           gzfiles=new String[]{};
          // zipfiles= new String[]{DeidData.unpackedFileLocation.get("dat.zip").getAbsolutePath(), DeidData.unpackedFileLocation.get("ref_vols.zip").getAbsolutePath()};
        }
    ...
    private void initComponents() {
        ...
        errlogButton.setText("Error Log");
        ...
        buttonPanelLayout.linkSize(new java.awt.Component[] {backButton, cancelButton, continueButton, errlogButton, helpButton}, org.jdesktop.layout.GroupLayout.HORIZONTAL);
        ...
        buttonPanelLayout.linkSize(new java.awt.Component[] {backButton, cancelButton, continueButton, errlogButton, helpButton}, org.jdesktop.layout.GroupLayout.VERTICAL);
    ...
    public static void advance() {
        ...
        try{
           ...
           // LoggerWrapper loggerWrapper = LoggerWrapper.getInstance();
            LoggerWrapper.myLogger.fine(nextPanel.getClass().getName());
    ...
    public static void previous() {
        ...
        try{
            ...
            //LoggerWrapper loggerWrapper = LoggerWrapper.getInstance();
            LoggerWrapper.myLogger.fine(prevPanel.getClass().getName());
            pagePanel.remove(0);
    ...
    public static javax.swing.JPanel pagePanel;
