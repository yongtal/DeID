...
public class Nifti1Dataset_AnalyzeFormat {
	...
	*	.nii<.gz>
	*/
	public Nifti1Dataset_AnalyzeFormat(String name) {
	...
	*
	*/
	public Nifti1Dataset_AnalyzeFormat() {
	...
	*/
	public void readHeader() throws IOException, FileNotFoundException {
		...
		orient.append((char)(ecs.readUnsignedByte()));
                bb = new byte [10];
                ecs.readFully(bb, 0, 10);
                originator = new StringBuffer(new String(bb));
                bb = new byte [10];
                ecs.readFully(bb, 0, 10);
	...
	//
	////////////////////////////////////////////////////////////////////
	public void copyHeader(Nifti1Dataset_AnalyzeFormat A) {
	...
	*/
	public static void main(String[] args) {
		...
		Nifti1Dataset_AnalyzeFormat nds = new Nifti1Dataset_AnalyzeFormat("D:\\test.nii");
		try {
			nds.readHeader();
			//nds.printHeader();
		}
